  ...
  return (
    <div className="w-full grid grid-cols-1 lg:grid-cols-2">
      <div
        ...
        className="z-0 h-[70vh] lg:h-[100vh] w-full  relative bg-cover bg-center flex justify-center items-center"
      ></div>
      <div className="absolute top-0 left-0 transalet-x-1/2 translate-y-1/2 flex flex-col w-full p-6 text-white uppercase text-[13vw] leading-[13vw] lg:text-[6vw] md:ml-20 gap-3 lg:leading-[6vw] font-black">
        <h1>Таекуондо</h1>
        <h1>клуб</h1>
